...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [user].[id] FROM [user] WHERE (([user].[name] = @param1) OR ([user].[name] = @param2))',
    string: 'SELECT [user].[id] FROM [user] WHERE (([user].[name] = \'foo\') OR ([user].[name] = \'bar\'))'
  },
  params: ['foo', 'bar']
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [user].[id] FROM [user] WHERE (([user].[name] = @param1) AND ([user].[name] = @param2))',
    string: 'SELECT [user].[id] FROM [user] WHERE (([user].[name] = \'foo\') AND ([user].[name] = \'bar\'))'
  },
  params: ['foo', 'bar']
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [user].[id] FROM [user] WHERE ([user].[name] IN (@param1, @param2))',
    string: 'SELECT [user].[id] FROM [user] WHERE ([user].[name] IN (\'foo\', \'bar\'))'
  },
  params: ['foo', 'bar']
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [user].[name] AS [user name] FROM [user] WHERE ([user].[name] = @param1)',
    string: 'SELECT [user].[name] AS [user name] FROM [user] WHERE ([user].[name] = \'brian\')'
  },
  params: ['brian']
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [user].[name] FROM [user] WHERE ([user].[name] = @param1)',
    string: 'SELECT [user].[name] FROM [user] WHERE ([user].[name] = \'brian\')'
  },
  params: ['brian']
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT name FROM user WHERE (name IS NOT NULL)',
    string: 'SELECT name FROM user WHERE (name IS NOT NULL)'
  },
  params: []
});
...
Harness.test({
  ...
  mysql: {
    text  : 'SELECT name,id FROM user WHERE (name IS NOT NULL)',
    string: 'SELECT name,id FROM user WHERE (name IS NOT NULL)'
  },
  params: []
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT name, id FROM user WHERE ((name IS NOT NULL) AND (id IS NOT NULL))',
    string: 'SELECT name, id FROM user WHERE ((name IS NOT NULL) AND (id IS NOT NULL))'
  },
  params: []
});
...
Harness.test({
  ...
  mysql: {
    text  : 'SELECT name FROM user WHERE ([user].[name] = @param1)',
    string: 'SELECT name FROM user WHERE ([user].[name] = \'brian\'')'
  },
  params: ['brian']
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT name FROM user WHERE (([user].[name] = @param1) AND ([user].[id] = @param2))',
    string: 'SELECT name FROM user WHERE (([user].[name] = \'brian\') AND ([user].[id] = 1))'
  },
  params: ['brian', 1]
});
