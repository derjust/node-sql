...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [post].* FROM [post] WHERE ([post].[id] IN (@param1))',
    string: 'SELECT [post].* FROM [post] WHERE ([post].[id] IN (1))'
  },
  params: [1]
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [post].* FROM [post] WHERE ([post].[id] IN (@param1, @param2))',
    string: 'SELECT [post].* FROM [post] WHERE ([post].[id] IN (1, 2))'
  },
  params: [1, 2]
});
...
Harness.test({
  ...
  mssql: {
    text  : 'SELECT [post].* FROM [post] WHERE ([post].[id] IN (@param1, @param2) OR [post].[id] IS NULL)',
    string: 'SELECT [post].* FROM [post] WHERE ([post].[id] IN (1, 2) OR [post].[id] IS NULL)'
  },
  params: [1, 2]
});
